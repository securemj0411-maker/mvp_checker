...
function Cases() {
  const samples = [
    {
      brand: "AI로 앱 만들기 클래스",
      sub: "비개발자 앱 출시 · 온라인 강의",
      explain:
        "강사가 커리큘럼·가격만 정해 ‘수강신청’ 랜딩을 먼저 띄우고, 강의 한 컷 찍기 전에 진짜 결제할 사람이 있는지부터 측정했습니다.",
      slug: "course-notion",
      ...
      report: [
        { k: "수요", v: "클릭률 5.2%에 들어온 사람의 10%가 ‘수강신청’까지 갔습니다. ‘AI로 직접 앱을 만든다(바이브코딩)’는 지금 가장 뜨거운 주제라 콜드 광고에도 진성 신청이 붙었습니다." },
        { k: "경쟁·대안", v: "유튜브 무료 영상은 많지만 ‘끝까지 출시’를 책임지는 커리큘럼엔 돈을 냅니다. ‘비개발자도 진짜 배포까지’가 차별점." },
        { k: "사업성", v: "수강료 99,000원, 수강신청 1건을 ₩1,900에 확보. 강의 찍기 전에 손익이 보입니다 — GO면 그때 제작 시작." },
      ],
      take: "GO — 수요 확인됐으니 이제 제작. 검증에 쓴 랜딩·수강신청자 명단을 그대로 첫 수강생으로.",
    },
    {
      brand: "AI 자동수익 클래스",
      sub: "AI 부업 · 수익화 강의",
      explain:
        "18강 녹화 전에 ‘수강신청’ 랜딩을 띄워, 진짜 돈 내고 들을 사람이 있는지부터 광고로 측정했습니다.",
      slug: "course-english",
      ...
      report: [
        { k: "수요", v: "클릭률은 6.9%로 폭발했지만 ‘수강신청’은 5건. 호기심 클릭은 많아도 ‘돈 내고 배울’ 신호는 거의 없었습니다 — ‘자동 수익’ 약속 자체가 의심받습니다." },
        { k: "경쟁·대안", v: "유튜브에 ‘AI로 월 천만원’류 콘텐츠가 무료로 범람. 비슷한 약속이 너무 흔해 차별점이 안 섭니다." },
        { k: "사업성", v: "과장된 수익 표현은 광고 승인도 막히고, 전환이 0에 가까워 광고를 키울수록 손해. 18강 녹화 전에 멈춰 몇 달을 아꼈습니다." },
      ],
      take: "NO-GO — 녹화 전에 멈춤. ‘자동 수익’ 대신 검증 가능한 구체 결과(특정 도구·업무)로 약속을 좁혀 재검증.",
    },
    {
      brand: "AI 영상 자동화 클래스",
      sub: "쇼츠 자동 양산 · 라이브 클래스",
      explain:
        "69만 원 라이브 클래스에 진짜 신청이 붙는지, ‘수강신청’ 랜딩으로 한 기수 모으기 전에 광고로 먼저 측정했습니다.",
      slug: "course-coding",
      ...
      report: [
        { k: "수요", v: "클릭률 4.4%로 관심은 강했습니다. 다만 69만 원 앞에서 결제까지는 17건 — 수요는 분명한데 가격 저항이 보입니다." },
        { k: "경쟁·대안", v: "무료 유튜브 튜토리얼이 많지만 ‘끝까지 돌아가는 자동화 파이프라인’엔 돈을 냅니다. 다만 69만 원 일시불이 진입 문턱." },
        { k: "사업성", v: "수강료 69만 원이라 신청 1건의 가치가 큽니다(CAC ₩6,800). 전환율만 올리면 손익이 크게 벌어집니다." },
      ],
      take: "PIVOT — 수요는 있다. 가격·결제조건(분납)·범위(특정 니치)를 바꿔 저항을 낮추면 충분히 GO.",
    },
  ];
  return (
