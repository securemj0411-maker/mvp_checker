...
function Hero({ variant = "a" }: { variant?: HeroVariant }) {
  ...
  const sub =
    variant === "a"
      ? "커리큘럼·가격만 정하면 됩니다. 신청 당일 라이브되는 수강신청 페이지에 진짜 광고를 걸어, 당신을 모르는 사람 수백 명이 ‘수강신청’을 누르는지 잽니다(실제 결제는 없습니다). 보통 2~3일이면, 녹화하기 전에 살 사람이 있는지 압니다."
          ...
          {[
            {
              ...
              c: verdict.go,
              bg: verdict.goBg,
              t: "수요와 수강료 모두 합격선을 넘었습니다. 진행할 근거가 확인됐습니다.",
            },
            {
              stamp: "PIVOT",
              c: verdict.pivot,
