...
const CASES: CaseData[] = [
  ...
  },
  {
    slug: "course-english",
    brand: "퇴근 후 영어회화",
    tagline: "왕초보 탈출 · 온라인 클래스",
    pattern: "무료 대안 포화형",
    verdict: "NO-GO",
    story:
      "20강 녹화에 들어가기 전에 ‘수강신청’ 랜딩을 띄워, 진짜 돈 내고 들을 사람이 있는지부터 광고로 측정했습니다.",
    ads: [
      { k: "노출", v: "41,000" },
      { k: "클릭", v: "451" },
      { k: "클릭률", v: "1.1%" },
    ...
    why: "관심은 있어도 ‘돈 내고 들을’ 신호가 약했습니다. 클릭률 1.1%에 수강신청 6건뿐. 왕초보 영어는 유튜브·스픽·듀오링고 같은 무료·저가 대안이 압도적이라, 콜드 광고로는 결제 의향이 붙지 않습니다.",
    risk:
      "20강 녹화에 들어갈 몇 달과 비용을 시작 전에 멈췄습니다. 같은 주제라도 ‘특정 직군·시험 전용’처럼 무료 대안과 다른 약속으로 좁히면 다시 검증할 가치가 있습니다.",
    reasons: ["수요 약함", "무료 대안 포화"],
    landing: { orientation: "mobile" },
  },
  {
    slug: "course-coding",
    brand: "비전공자 코딩 부트캠프",
    tagline: "6주 라이브 · 고가 부트캠프",
    pattern: "고가·고관여형",
    verdict: "PIVOT",
    story:
      "89만 원 부트캠프에 진짜 신청이 붙는지, 한 기수를 모으기 전에 ‘수강신청’ 랜딩으로 광고를 돌려 측정했습니다.",
    ads: [
      { k: "노출", v: "33,000" },
      { k: "클릭", v: "1,287" },
      { k: "클릭률", v: "3.9%" },
    ...
    why: "클릭률 3.9%로 관심은 강했습니다. 다만 89만 원 일시불 앞에서 결제까지는 14건 — 수요는 분명한데 가격 저항이 또렷합니다. 객단가가 커서 신청 1건의 가치(CAC ₩7,400 대비)는 충분히 큽니다.",
    risk:
      "수요가 없는 게 아니라 가격·결제조건이 문턱입니다. 분납·선취업후납·기수 규모 축소로 저항을 낮춰 재검증하면 충분히 GO로 넘어갈 수 있습니다.",
    reasons: ["수요 강함", "가격 저항"],
    landing: { orientation: "mobile" },
  },
];
