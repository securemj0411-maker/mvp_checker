...
const STEPS = [
  {
    ...
    body: [
      "진짜 서비스처럼 보이는 한 장짜리 검증용 사이트를 만듭니다. 예쁘게가 아니라 진짜처럼. 제목, 누구를 위한 것인지, 어떤 문제를 해결하는지, 그리고 얼마인지.",
  ...
  },
  {
    ...
    body: [
      "광고 쪽 숫자(노출, 클릭률)는 전부 무시해도 됩니다. 볼 것은 하나입니다. 페이지에 들어온 모르는 사람 100명 중 몇 명이 '사겠다'를 눌렀나.",
  ...
  },
  {
    ...
    body: [
      ...
      "신호가 잡히면 그때부터 조금 더 봅니다: 어떤 문구·키워드에서 들어왔는지, 한 명 데려오는 데 얼마가 들었는지(고객 획득 비용). 수요가 있어도 이 비용이 한 번 결제 금액(객단가)보다 크면 팔수록 손해입니다.",
    ],
  },
  {
    n: "5단계",
