  ...
  return (
    <div className="mt-6 space-y-3">
      ...
      <Sec title="① 첫 응답 (카톡 기본)" open>
        <p>
          폼 데이터 3개(강의 형태/강의 주제 한 줄, 단계, 최우선 관심)를 반드시
          본문에 넣어 개인화합니다.
        </p>
        <Tmpl>{`{이름}님, 안녕하세요. 비즈필터입니다.

남겨주신 내용 확인했습니다. {분야}에서 "{강의 주제 한 줄}" 강의를
준비 중이시고, 현재 {단계} 단계에 계신 것으로 이해했습니다.
...
지금 미루시는 이유가 비용인가요, 검증 필요성 자체인가요?`}</Tmpl>
      ...
      <Sec title="⑥ 채널 결정 (10분 체크)">
        ...
        <p className="mt-2 text-xs text-text-tertiary">
          ...
          죽은 문구 끄기. 전 문구 사망 = 강의 주제 문제, 한 문구 생존 = 문구
          문제.
        </p>
      </Sec>
...
시점이 아니신 것 같아 이 건은 정리해두겠습니다. 강의 주제가
