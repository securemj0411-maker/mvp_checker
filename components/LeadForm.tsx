...
const QUESTIONS: Question[] = [
  ...
  {
    id: "build",
    title: "광고를 걸 페이지, 준비된 게 있으세요?",
    sub: "검증용 페이지는 실제 서비스인 것처럼 보이는 한 장짜리 웹페이지예요. 여기에 광고를 걸어 진짜 반응(클릭·결제 버튼)을 측정합니다. 답에 따라 가장 싼 경로를 추천해 드립니다.",
    options: [
      {
        value: "self",
        label: "직접 만들 수 있어요",
      ...
      },
      {
        value: "need",
        label: "비즈필터가 만들어 주세요",
        hint: "실제 서비스처럼 보이는 검증용 페이지를 저희가 대신 제작합니다",
      },
      {
        value: "built",
        label: "이미 있어요",
      ...
      <div className="cold-panel space-y-5 rounded-lg p-6 sm:p-8">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-text-secondary">
            지금은 짧아도 괜찮습니다. 한 줄로 시작하면 다음 화면에서 저희가
            같이 구체화해 드립니다. 끝까지 답하시면 어디에 광고를 걸어 수백
            명을 불러올지 담긴 검증 설계서를 무료로 드립니다.
          </p>
        </div>
        <textarea
          value={idea}
